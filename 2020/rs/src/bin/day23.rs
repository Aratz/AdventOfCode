mod day23 {
    ...
    fn iter_circle(mut cups: usize, n_moves: usize, n_cups: usize) -> Vec<usize> {
        let mut circle: Vec<usize> = vec![0; n_cups + 1];
        ...
        while cups != 0 {
            circle[cups % base] = last_digit;
            last_digit = cups % base;
            cups /= base;
        }
        if n_cups == 9 {
            circle[first_digit] = last_digit;
        }
        else {
            circle[n_cups] = last_digit;
        }
