mod day17a {
    ...
    pub struct Grid(HashSet<(i32, i32, i32)>);
    ...
    impl Grid {
        ...
        fn n_neighbors(&self, coords: &(i32, i32, i32)) -> usize {
            let (x, y, z) = coords;
...
fn main() {
    ...
    let mut grid: day17a::Grid = buffer.parse().unwrap();
    for _ in 0..6 {
        grid.update();
    }
