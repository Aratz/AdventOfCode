class Fighter:
    def __init__(self, team, pos, hp=200):
        ...
        self.pos = pos
        self.hp = 200
        self.power = 3 if team == 'G' else 23
...
nround = 0
gameover = False
init_elves = len([f for f in fighters.values() if f.team=='E'])
while not gameover:
...
print("lost: {}".format(init_elves - len([f for f in fighters.values() if f.team=='E'])))
